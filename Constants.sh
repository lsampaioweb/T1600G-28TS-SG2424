...
VLAN_PATH_OF_VARIABLES="$OPTION_FOLDER/vlan/*.sh"
PVID_PATH_OF_PORT_VARIABLES="$OPTION_FOLDER/pvid/port/*.sh"
PVID_PATH_OF_LAG_VARIABLES="$OPTION_FOLDER/pvid/lag/*.sh"
